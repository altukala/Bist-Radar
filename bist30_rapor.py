...
main {{ max-width:1240px; margin:auto; padding:42px 22px 64px; }}
...
table {{ width:100%; border-collapse:collapse; min-width:940px; }} th,td {{ padding:14px 15px; text-align:left; border-bottom:1px solid #edf1f5; }}
...
<h1>BIST30 Genel Görünüm</h1><p class="subtitle">{now} · Fiyat trendi bazlı günlük tarama · Yatırım tavsiyesi değildir.</p>
...
<div class="table-wrap"><table><thead><tr><th>Hisse</th><th>Son fiyat</th><th>5 gün</th><th>20 gün</th><th>Görünüm</th><th>Neden?</th></tr></thead><tbody id="rows">{rows}</tbody></table></div>
<footer>Renkler yalnızca fiyat trendini özetler. Nihai karar için şirket finansalları, KAP açıklamaları ve kişisel riskin ayrıca değerlendirilmelidir.</footer>
</main><script>
